...
class BootstrapServer {
  ...
  getStepInstructions(stepId, state) {
    ...
    const instructions = {
      ...
      "3.2": "Generate context_master_guide.md, technical_status.md, ROADMAP.md, bootstrap_decisions.md (from sync), FLUXFRAME_MANUAL.md (from fluxframe_manual.template.md - if exists, ask replace/append), FLUXFRAME_GETTING_STARTED.md (from fluxframe_getting_started.template.md - always generate), and workflows. Documentation goes to final location.",
